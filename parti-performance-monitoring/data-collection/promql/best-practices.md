...
## 监控模式 <a id="jian-kong-mo-shi"></a>

除了上述介绍的不同监控级别以外。实际上根据不同的系统类型和目标，这里还有一些通用的套路和模式可以使用。

## 4个黄金指标 <a id="4-ge-huang-jin-zhi-biao"></a>
...
![&#x8BC6;&#x522B;&#x8D44;&#x6E90;&#x74F6;&#x9888;](../../../.gitbook/assets/usemethod.png)
